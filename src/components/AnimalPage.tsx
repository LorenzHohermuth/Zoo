...
export default function AnimalPage({imageTop, imageBottom,name,sciName,endangered, popultaion, weight, size,
  ...
  return (
    <div>
        <img src={`/Zoo/Images/${imageTop}`} alt="tierbilder-wwf" className='w-screen object-cover lg:h-144 md:h-80 h-48'/>
            ...
            <div className='lg:flex md:text-xl flex-row-reverse justify-center'>
              <div className='lg:ml-20 ml-10 lg:my-10 my-16'>
                <div className='flex items-center'>
                  <img className='md:h-14 h-12' src="/Zoo/Icons/name.svg" alt="nametag" />
                  <div>
                ...
                <div className='flex my-5 items-center'>
                  <img className='md:h-14 h-12 p-3' src="/Zoo/Icons/warning.svg" alt="nametag" />
                  <div>
                ...
                <div className='flex my-5 items-center'>
                  <img className='md:h-14 h-12 p-1' src="/Zoo/Icons/popultaion.svg" alt="nametag" />
                  <div>
                ...
                <div className='flex my-5 items-center'>
                  <img className='md:h-14 h-12 p-1.5' src="/Zoo/Icons/ruler.svg" alt="nametag" />
                  <div>
        ...
        <div className='my-20 2xl:flex bg-gray-800 w-full py-10 items-center'>
          <img src={`/Zoo//Images/${imageBottom}`} className='lg:h-128 lg:w-250 object-cover w-full' alt="" />
